...
class LegsControllerTest < ActionController::TestCase
  ...
  test "should create leg" do
    assert_difference('Leg.count') do
      post :create, leg: { arrives: @leg.arrives, from: @leg.from, full: @leg.full, leaves: @leg.leaves, next: @leg.next, prev: @leg.prev, to: @leg.to }
    end
  ...
  test "should update leg" do
    put :update, id: @leg, leg: { arrives: @leg.arrives, from: @leg.from, full: @leg.full, leaves: @leg.leaves, next: @leg.next, prev: @leg.prev, to: @leg.to }
    assert_redirected_to leg_path(assigns(:leg))
  end
